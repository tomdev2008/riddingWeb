 ...
 * @version CreateTime：2013-2-6 下午03:18:42 Class Description
 */
public class TestForClass {
	
	public static void main(String[] args) throws Exception {

		Config.ACCESS_KEY = "8djjv3hXfS8eDOg9gR5UxxIpkmhfGg069FBv5c1e";
		Config.SECRET_KEY = "7oebuztbTfddVtI8dtY_QeftnWB09uZFPIQ8JuUm";
		...
		PutFileRet putFileRet = RSClient.putFile(putAuthRet.getUrl(), bucketName, key, "", path + "/" + key, "CustomData", callbackParams);
		if (!putFileRet.ok()) {
