...
/**
 * 缩略图生成器， 对于负载很低， 比如一天在5000张以内的缩略图生成可以 调用此接口， 否则请调用小马开的graphMagrics的jni接口， 具体联系
 * 小马mamingli@corp.netease.com
 * 
...
public final class ThumbnailUtil {
	...
	public static final void main(String[] args) throws Exception {
		...
		// File("D:/TDDOWNLOAD/origin.jpg"));
		// FileOutputStream out = new FileOutputStream(new
		// File("D:/TDDOWNLOAD/1.jpg"));

		// ThumbnailUtil.generateThumb(new File("D:/TDDOWNLOAD/origin.jpg"), new
		// File("D:/TDDOWNLOAD/1.jpg"), ImageType.BMP, 100, 100);
		// ThumbnailUtil.cutImage(in, out, ImageCutPosition.TOP_LEFT, 2000,
		// 200);

		// BufferedImage originalImage = ImageIO.read(new
		// File("D:/TDDOWNLOAD/origin.jpg"));
		// BufferedImage buf = ThumbnailUtil.generateThumb(originalImage,
		// ImageType.BMP, 20, 20);
		// ImageIO.write(buf, "bmp", new FileOutputStream(new
		// File("D:/TDDOWNLOAD/1.bmp")));
		...
		// BufferedImage originalImage = ImageIO.read(new
		// File("D:/TDDOWNLOAD/origin.jpg"));
		// BufferedImage buf = ThumbnailUtil.cutImage(originalImage,
		// ImageCutPosition.TOP_LEFT, 300, 400);
		// ImageIO.write(buf, "jpg", new FileOutputStream(new
		// File("D:/TDDOWNLOAD/1.jpg")));
