...
var popUpCal = {
    ...
    dayNames: ['SUN', 'MON', 'TUR', 'WED', 'THR', 'FRI', 'SAT'], // Names of days starting at Sunday
    monthNames: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], // Names of months
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select" style="width:34px;margin-left:0px;margin-right:1px;"><select id="calendar_hour" style="width:38px">';
            ...
            timeSelect += '</select></div><div class="select" style=" width:7px;">' + this.timeSeparators[1] + '</div> <div class="select" style="width:34px"><select id="calendar_minute" style="width:38px">';
            for (var a = 0; a <= 59; a++) {
        ...
        if (!this.changeYear) {
            ...
            html += '<div class="select" style="width:50px"><select id="calendar_newYear" style="width:53px">';
		...
		if (!this.changeMonth) {
            ...
            html += '<div class="select" style="width:50px; margin-left:1px"><select id="calendar_newMonth" style="width:50px">';
    ...
    connectCalendar: function(target) {
        ...
        if (this.autoPopUp == 'button' || this.autoPopUp == 'both') { // pop-up calendar when button clicked
            ...
            jQuery((this.buttonImageOnly ? 'img' : 'button') + '.calendar_trigger', jQueryinput.parent('span')).click(this.showFor);
        }
    ...
    setupActions: function() {
        ...
        jQuery('.calendar_daysRow td:has(a)').hover( // highlight current day
			function() {
			    jQuery(this).addClass('calendar_daysCellOver');
			}, function() {
			    jQuery(this).removeClass('calendar_daysCellOver');
			});
        jQuery('.calendar_daysRow td:has(a)').click(function() { // select day
            popUpCal.selectedDay = jQuery(this).find('>a').html();
            popUpCal.selectDate();
        });
    ...
    showTime: function() {
        ...
        // add calendar to element to calendar Div
        jQuery('#calendar_div').empty().append(html).show(this.speed);
        jQuery('#CLD_OK').addClass('btOK_out');
        this.input[0].focus();
        //this.setupActions();
    ...
    timeActions: function() {
        ...
        jQuery('#CLD_OK').click(function() { // close button link
        ...
        jQuery('#CLD_OK').hover(
			function() {
			    jQuery(this).addClass('btOK_over');
			}, function() {
			    jQuery(this).removeClass('btOK_over');
			    jQuery(this).addClass('btOK_out');
			});
    },
